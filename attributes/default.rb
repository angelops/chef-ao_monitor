...
default['ao_monitor']['additional_packages'] = %w{nagcon nagios-plugins nagios-plugins-contrib}
default['ao_monitor']['install_plugins'] = %w{check_flume_node.sh check_flume_node_status.sh check_hadoop_datanodes.rb check_hadoop_tasktracker.sh check_hbase.rb hadoop_jmx.rb}
